        ...
        try:
            if isinstance(default, dict):
                ...
                if len(default) > 0:
                    ...
                    pass
                    parser.add_argument("--{}".format(param), action="append", default=default, help=description)
            else:
                pass
                parser.add_argument("--{}".format(param), type=OrNone(default), default=default, help=description)
